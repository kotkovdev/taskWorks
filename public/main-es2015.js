...
/* harmony import */ var _tasks_task_task_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./tasks/task/task.component */ "./src/app/tasks/task/task.component.ts");
/* harmony import */ var _tasks_new_task_new_task_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./tasks/new-task/new-task.component */ "./src/app/tasks/new-task/new-task.component.ts");
...
/* harmony import */ var _reports_new_report_new_report_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./reports/new-report/new-report.component */ "./src/app/reports/new-report/new-report.component.ts");
/* harmony import */ var _Projects_projects_list_projects_list_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./Projects/projects-list/projects-list.component */ "./src/app/Projects/projects-list/projects-list.component.ts");
/* harmony import */ var _Projects_new_project_new_project_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./Projects/new-project/new-project.component */ "./src/app/Projects/new-project/new-project.component.ts");
/* harmony import */ var _users_users_list_users_list_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./users/users-list/users-list.component */ "./src/app/users/users-list/users-list.component.ts");
/* harmony import */ var _users_user_form_user_form_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./users/user-form/user-form.component */ "./src/app/users/user-form/user-form.component.ts");
/* harmony import */ var _reports_edit_report_edit_report_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./reports/edit-report/edit-report.component */ "./src/app/reports/edit-report/edit-report.component.ts");
...
/* harmony import */ var _messages_messages_form_messages_form_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./messages/messages-form/messages-form.component */ "./src/app/messages/messages-form/messages-form.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _tasks_task_task_component__WEBPACK_IMPORTED_MODULE_13__["TaskComponent"],
            _tasks_new_task_new_task_component__WEBPACK_IMPORTED_MODULE_14__["NewTaskComponent"],
            _reports_reports_component__WEBPACK_IMPORTED_MODULE_15__["ReportsComponent"],
            _Projects_projects_list_projects_list_component__WEBPACK_IMPORTED_MODULE_17__["ProjectsListComponent"],
            _Projects_new_project_new_project_component__WEBPACK_IMPORTED_MODULE_18__["NewProjectComponent"],
            _users_users_list_users_list_component__WEBPACK_IMPORTED_MODULE_19__["UsersListComponent"],
            _users_user_form_user_form_component__WEBPACK_IMPORTED_MODULE_20__["UserFormComponent"],
            _reports_new_report_new_report_component__WEBPACK_IMPORTED_MODULE_16__["NewReportComponent"],
            _reports_edit_report_edit_report_component__WEBPACK_IMPORTED_MODULE_21__["EditReportComponent"],
            _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_22__["DashboardComponent"],
            _messages_messages_form_messages_form_component__WEBPACK_IMPORTED_MODULE_23__["MessagesFormComponent"],
        ],
        imports: [
...
class Message {
    constructor(id, user_id, task_id, message, status, completion, created_at = null, updated_at = null) {
        this.id = id;
...
class Task {
    constructor(id, title, status_id, user_id, report_id, project_id, description, completion = 0) {
        this.id = id;
        this.title = title;
...
/* harmony import */ var src_app_services_messages_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! src/app/services/messages.service */ "./src/app/services/messages.service.ts");
/* harmony import */ var _interfaces_Message__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../interfaces/Message */ "./src/app/interfaces/Message.ts");
...
let MessagesFormComponent = class MessagesFormComponent {
    constructor(formBuilder, route, taskService, messagesService) {
        this.formBuilder = formBuilder;
        this.route = route;
    ...
    onSubmit() {
        if (this.messageForm.valid) {
            ...
            let message = new _interfaces_Message__WEBPACK_IMPORTED_MODULE_5__["Message"](null, null, this.taskId, messageText, status, completion);
            console.log(message);
...
MessagesFormComponent.ctorParameters = () => [
    ...
    { type: src_app_services_tasks_service__WEBPACK_IMPORTED_MODULE_6__["TasksService"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [src_app_services_tasks_service__WEBPACK_IMPORTED_MODULE_6__["TasksService"],] }] },
    { type: src_app_services_messages_service__WEBPACK_IMPORTED_MODULE_4__["MessagesService"], decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [src_app_services_messages_service__WEBPACK_IMPORTED_MODULE_4__["MessagesService"],] }] }
];
MessagesFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-messages-form',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./messages-form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/messages/messages-form/messages-form.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./messages-form.component.scss */ "./src/app/messages/messages-form/messages-form.component.scss")).default]
    }),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](2, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(src_app_services_tasks_service__WEBPACK_IMPORTED_MODULE_6__["TasksService"])),
    tslib__WEBPACK_IMPORTED_MODULE_0__["__param"](3, Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"])(src_app_services_messages_service__WEBPACK_IMPORTED_MODULE_4__["MessagesService"]))
...
let MessagesService = class MessagesService extends _http_helper_service__WEBPACK_IMPORTED_MODULE_3__["HttpHelperService"] {
    constructor(http) {
        super();
        this.http = http;
    }
